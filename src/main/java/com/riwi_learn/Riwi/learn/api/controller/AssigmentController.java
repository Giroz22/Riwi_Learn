...
public class AssigmentController {
    ...
    public ResponseEntity<List<SubmissionBaseResponse>> getAllSubmission(@PathVariable String id) {
        return ResponseEntity.ok().body(this.assigmentService.getAllSubmissions(id));
    }
}
